...
export class ChangeNonShiftComponent implements OnInit, AfterViewInit, OnDestroy {
                      ...
                      .subscribe(
                        (data: any) => {
                          if (data.length > 0) {
                            ...
                            // var ShiftRoteCountArray: ShiftRoteCountGetApiClass[] = []
                            // for (let oneShiftRoteDate of ShiftRoteCheckClass.ShiftRoteDate) {
                            //   ShiftRoteCountArray.push({
                            //     EmpID: this.SearchMan.EmpCode.toString(),
                            //     ShiftRoteDate: oneShiftRoteDate.ShiftDate
                            //   })
                            // }

                            // from(ShiftRoteCountArray)
                            //   .pipe(takeWhile(() => this.api_subscribe))
                            //   .pipe(
